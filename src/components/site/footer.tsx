        ...
        <footer className="bg-[#fcfcfc] pt-16 pb-8">
            <div className="container mx-auto">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center">
                                ...
                                <a href="tel:5551234567" className='hover:underline decoration-accent'>+1 (555) 123-4567</a>
                            </li>
                            <li className="flex items-center">
                                <Mail size={20} className="mr-2 flex-shrink-0" />
                                <a href="mailto:info@sitebuilder.com" className='hover:underline decoration-accent'>info@sitebuilder.com</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t mt-12 pt-8 text-center text-muted-foreground">
                    <p>
                        &copy; {currentYear} Site Builder. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
