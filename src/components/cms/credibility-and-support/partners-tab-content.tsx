...
import { partnerDefaultvalue, TCredibilityAndSupport } from "@/schemas/credibility-and-support.schema";
import { TMediaSchema } from "@/schemas/media.schema";
import { MediaInput, MediaItem } from "@/components/forms/media-field";

export default function PartnersTabContent() {
                ...
                render={() => (
                    <FormItem>
                                    ...
                                    fields.map((f, idx) => {
                                        return (
                                            <FormField
                                                ...
                                                name={`partners.${idx}`}
                                                render={({ field }) => {
                                                    const fieldError = Array.isArray(form.formState.errors.partners) && !!form.formState.errors.partners[idx];
                        ...
                        <Button
                            ...
                            onClick={() => append(partnerDefaultvalue)}
                        >
