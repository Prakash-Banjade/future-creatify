...
function html(params: { url: string; host: string }) {
    ...
    const logoUrl = `${new URL(url).origin}/_next/image?url=%2Flogo-magenta.png&w=128&q=75`;
            ...
            <td align="center" style="padding: 40px 40px 20px 40px; background: #fff9e6;">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                    <!-- Brand Logo -->
                      <img src=${logoUrl} alt="Future Creatify Logo" width="64" height="64" style="display: block; border: 0;" />
                  </td>
                </tr>
                <tr>
                  <td align="center">
