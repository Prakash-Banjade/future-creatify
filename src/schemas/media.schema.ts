...
export const mediaSchema = z.object({
    ...
    alt: z.string({ required_error: "Alt text is required" }).min(3, { message: "Alt text must be at least 3 characters long" }).max(100, { message: "Alt text must be at most 100 characters long" }),
